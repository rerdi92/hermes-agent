...
export const zh: Translations = {
  ...
  assistant: {
    ...
    clarify: {
      ...
      responsePendingMessage: 'Hermes 未能及时确认这次选择。后端可能仍会收到它，请稍等片刻再重试，以避免重复响应。',
      responseExpiredTitle: '澄清请求已过期',
      responseExpiredMessage: '该选择请求已不再等待响应。请等 Hermes 再次询问后，回答新的提示。',
      ...
      multiSelectHint: '多选：使用右侧圆点暂存选项，然后按“提交已选择”。',
